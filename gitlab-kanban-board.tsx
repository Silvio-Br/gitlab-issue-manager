  ...
  function DroppableColumn({ column }: { column: KanbanColumn }) {
    ...
    return (
      <div className="flex flex-col">
        <div className="rounded-t-lg p-4 border-b" style={{ backgroundColor: `${column.color}20` }}>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  <div className="flex items-center gap-1">
                    ...
                    <span>Créé par {selectedIssue.author.name}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Clock className="w-4 h-4" />
                    <span>{new Date(selectedIssue.created_at).toLocaleDateString("fr-FR")}</span>
                  </div>
                  {/* Remplacer cette ligne dans la section Issue Info : */}
                  {/* <Badge variant={selectedIssue.state === "opened" ? "default" : "secondary"}>
                    {selectedIssue.state === "opened" ? "Ouvert" : "Fermé"}
                  </Badge> */}
                  {/* Par : */}
              ...
              <div>
                <h4 className="text-sm font-medium mb-3 flex items-center gap-2">
                  ...
                  Commentaires ({issueComments.length})
                </h4>
              ...
              <div className="space-y-6 pr-3">
                ...
                {allLabelsForFilter.length > 0 && (
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Sélectionner des labels...">
                ...
                {allAssigneesWithIds.length > 0 && (
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="none">Aucun assigné</SelectItem>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="max-h-64 overflow-y-auto">
                    <DropdownMenuLabel>Filtrer par labels</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    {allLabelsForFilter.map((label) => (
                      <DropdownMenuCheckboxItem
                        key={label}
            ...
            <div className="mt-4 text-sm text-gray-600">
              {filteredIssues.length} issue{filteredIssues.length !== 1 ? "s" : ""} trouvée
